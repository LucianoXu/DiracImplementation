...
%    nat_of_bin(bin_add(x,y)) ;
  ...
  nat_of_bin(B) + nat_of_bin(B) =
    nat_of_bin(bin_add(B,B)) ;

  nat_of_bin(B) + nat_of_bin(y.0) =
    nat_of_bin(bin_add(B,y.0)) ;

  nat_of_bin(B) + nat_of_bin(y.1) =
    nat_of_bin(bin_add(B,y.1)) ;

  nat_of_bin(x.0) + nat_of_bin(y) =
    nat_of_bin(bin_add(x.0,y)) ;

  nat_of_bin(x.1) + nat_of_bin(y) =
    nat_of_bin(bin_add(x.1,y)) ;
...
%
  ...
  bin_add(B.1.1.1.1.1.0.1.0.0.0, B.1.1.1.1.1.0.1.0.0.1) =
  bin_add(B.1.1.1.1.1.0.1.0.0.1, B.1.1.1.1.1.0.1.0.0.0) ;
