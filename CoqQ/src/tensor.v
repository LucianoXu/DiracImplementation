...
Require Import mcextra notation prodvect mxpred hermitian.
...
Notation "f .[ i0 <- v ]" := (@ffun_set _ _ i0 v f) : fun_scope.
...
Lemma dim_tensor : (Vector.dim tensor_hermitianType = \prod_i Vector.dim (E i))%N.
Proof.
...
Definition tensor_chs_eb (i : 'I_(Vector.dim [hermitianType of T])) : T
...
Definition tensor_chsMixin := ChsMixin tensor_chs_eb_dot tensor_chs_dim_proper.
Canonical tensor_chsType := 
  Eval hnf in [chsType of T for ChsType tensor_chsMixin].
