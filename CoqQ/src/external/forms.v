...
Reserved Notation "'[ u , v ]"
  (at level 2, u at level 60, format "'[hv' ''[' u , '/ '  v ] ']'").
Reserved Notation "'[ u , v ]_ M"
         (at level 2, u at level 60, M at next level, format "'[hv' ''[' u , '/ '  v ]_ M ']'").
Reserved Notation "'[ u ]_ M" (at level 2, u at level 60, format "''[' u ]_ M").
Reserved Notation "'[ u ]" (at level 2, u at level 60, format "''[' u ]").
...
without loss ou: u / '[u, v] = 0.
  ...
  by have:= IHo _ ou; rewrite mulrDl -leifBLR subrr ou normCK mul0r.
...
congr (_ <= _ ?= iff _); first by exact: ReE.
apply: andb_id2r.
rewrite free_cons span_seq1 seq1_free -negb_or negbK orbC.
