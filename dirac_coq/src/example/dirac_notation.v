...
(******************************************************************************)
(* formalization :                                                            *)
(* L1. core language DN (without big sum and fst/snd) with static type        *)
...
Fixpoint L1_L2_A_base (A : AType) (a : Playground0.A_base eval_AT ca A) : @A_base ca A :=
  match a with
  | Playground0.A_var n => A_var n
  | Playground0.A_ground A a => A_ground a
  | Playground0.A_pair A1 A2 a1 a2 => A_pair (L1_L2_A_base a1) (L1_L2_A_base a2)
  end.

Fixpoint L1_L2_S_scalar (s : Playground0.S_scalar eval_AT sname ca ck cb co) : @S_scalar ca :=
  match s with
    | Playground0.S_var n => S_var n
    | Playground0.S_0 => S_0
    | Playground0.S_1 => S_1
    | Playground0.S_delta A a1 a2 => S_delta (L1_L2_A_base a1) (L1_L2_A_base a2)
    | Playground0.S_add s1 s2 => S_add (L1_L2_S_scalar s1) (L1_L2_S_scalar s2)
    | Playground0.S_mul s1 s2 => S_mul (L1_L2_S_scalar s1) (L1_L2_S_scalar s2)
    | Playground0.S_conj s => S_conj (L1_L2_S_scalar s)
    | Playground0.BK_inner A b k => BK_inner (L1_L2_B_bra b) (L1_L2_K_ket k)
  end
with L1_L2_K_ket A (k : Playground0.K_ket eval_AT sname ca ck cb co A) : @K_ket ca A :=
  match k with
    | Playground0.K_var n => K_var n
    | Playground0.K_0 A => K_0
    | Playground0.K_ground A a => K_ground (L1_L2_A_base a)
    | Playground0.B_adj A b => B_adj (L1_L2_B_bra b)
    | Playground0.K_scale s A k => K_scale (L1_L2_S_scalar s) (L1_L2_K_ket k)
    | Playground0.K_add A k1 k2 => K_add (L1_L2_K_ket k1) (L1_L2_K_ket k2)
    | Playground0.K_apply A1 A2 o k => K_apply (L1_L2_O_opt o) (L1_L2_K_ket k)
    | Playground0.K_ten A1 A2 k1 k2 => K_ten (L1_L2_K_ket k1) (L1_L2_K_ket k2)
  end
with L1_L2_B_bra A (b : Playground0.B_bra eval_AT sname ca ck cb co A) : @B_bra ca A :=
  match b with
    | Playground0.B_var n => B_var n
    | Playground0.B_0 A => B_0
    | Playground0.B_ground A a => B_ground (L1_L2_A_base a)
    | Playground0.K_adj A k => K_adj (L1_L2_K_ket k)
    | Playground0.B_scale s A b => B_scale (L1_L2_S_scalar s) (L1_L2_B_bra b)
    | Playground0.B_add A b1 b2 => B_add (L1_L2_B_bra b1) (L1_L2_B_bra b2)
    | Playground0.B_apply A1 A2 b o => B_apply (L1_L2_B_bra b) (L1_L2_O_opt o)
    | Playground0.B_ten A1 A2 b1 b2 => B_ten (L1_L2_B_bra b1) (L1_L2_B_bra b2)
  end
with L1_L2_O_opt A1 A2 (o : Playground0.O_opt eval_AT sname ca ck cb co A1 A2) : @O_opt ca A1 A2 :=
  match o with
    | Playground0.O_var n => O_var n
    | Playground0.O_0 A1 A2 => O_0
    | Playground0.O_1 A => O_1
    | Playground0.KB_outer A1 A2 k b => KB_outer (L1_L2_K_ket k) (L1_L2_B_bra b)
    | Playground0.O_adj A1 A2 o => O_adj (L1_L2_O_opt o)
    | Playground0.O_scale s A1 A2 o => O_scale (L1_L2_S_scalar s) (L1_L2_O_opt o)
    | Playground0.O_add A1 A2 o1 o2 => O_add (L1_L2_O_opt o1) (L1_L2_O_opt o2)
    | Playground0.O_comp A1 A2 A3 o1 o2 => O_comp (L1_L2_O_opt o1) (L1_L2_O_opt o2)
    | Playground0.O_ten A1 A2 A3 A4 o1 o2 => O_ten (L1_L2_O_opt o1) (L1_L2_O_opt o2)
  end.

Variable (av : A_value ca).

Lemma L1_L2_A_sem A (a : Playground0.A_base eval_AT ca A) :
  Playground0.A_sem av a = A_sem av (L1_L2_A_base a).
Proof. by elim: a=>// A1 A2/= a1 -> a2 ->. Qed.

Let L1_L2_S_sem_eq :=
  (forall s : Playground0.S_scalar eval_AT sname ca ck cb co, 
  Playground0.S_sem av sv kv bv ov s = S_sem av (L1_L2_S_scalar s)).
Let L1_L2_K_sem_eq :=
  (forall A (k : Playground0.K_ket eval_AT sname ca ck cb co A),
   Playground0.K_sem av sv kv bv ov k = K_sem av (L1_L2_K_ket k)).
Let L1_L2_B_sem_eq :=
  (forall A (b : Playground0.B_bra eval_AT sname ca ck cb co A),
   Playground0.B_sem av sv kv bv ov b = B_sem av (L1_L2_B_bra b)).
Let L1_L2_O_sem_eq :=
  (forall A1 A2 (o : Playground0.O_opt eval_AT sname ca ck cb co A1 A2),
   Playground0.O_sem av sv kv bv ov o = O_sem av (L1_L2_O_opt o)).

Lemma L1_L2_All_sem : L1_L2_S_sem_eq /\ L1_L2_K_sem_eq /\ L1_L2_B_sem_eq /\ L1_L2_O_sem_eq.
Proof.
apply Playground0.All_syn_mutind=>//.
(* about scalar *)
- by move=>A a1 a2 /=; rewrite -L1_L2_A_sem -L1_L2_A_sem.
- by move=> /= s1 <- s2 <-.
- by move=> /= s1 <- s2 <-.
- by move=> /= s <-.
- by move=> /= A b <- k <-.
(* about ket *)
- by move=> /= A a; rewrite -L1_L2_A_sem.
- by move=> /= A b <-.
- by move=> /= s <- A k <-.
- by move=> /= A k1 <- k2 <-.
- by move=> /= A1 A2 o <- k <-.
...
Lemma L1_L2_S_sem s : 
  Playground0.S_sem av sv kv bv ov s = S_sem av (L1_L2_S_scalar s).
Proof. by move: L1_L2_All_sem s =>[]. Qed.

Lemma L1_L2_K_sem A k :
   Playground0.K_sem av sv kv bv ov k = K_sem av (@L1_L2_K_ket A k).
Proof. by move: L1_L2_All_sem k =>[] _ []. Qed.

Lemma L1_L2_B_sem A b :
   Playground0.B_sem av sv kv bv ov b = B_sem av (@L1_L2_B_bra A b).
Proof. by move: L1_L2_All_sem b =>[] _ [] _ []. Qed.

Lemma L1_L2_O_sem A1 A2 o :
   Playground0.O_sem av sv kv bv ov o = O_sem av (@L1_L2_O_opt A1 A2 o).
Proof. by move: L1_L2_All_sem o =>[] _ [] _ []. Qed.
...
Section Relation_L2_L3.

Fixpoint L2_L3_A_base (ca : Gamma_A) (A : AType) (a : Playground1.A_base eval_AT (ca := ca) A) : A_base :=
  match a with
  | Playground1.A_var n => A_var n
  | Playground1.A_ground A a => A_ground a
  | Playground1.A_pair A1 A2 a1 a2 => A_pair (L2_L3_A_base a1) (L2_L3_A_base a2)
  | Playground1.A_fst A1 A2 a => A_fst (L2_L3_A_base a)
  | Playground1.A_snd A1 A2 a => A_snd (L2_L3_A_base a)
  end.

Fixpoint L2_L3_ST_syn (A : AType) (a : Playground1.ST_syn cst A) : ST_syn :=
  match a with
  | Playground1.ST_var n => ST_var n
  | Playground1.ST_uni A => ST_uni (AT_ground A)
  | Playground1.ST_prod A1 A2 S1 S2 => ST_prod (L2_L3_ST_syn S1) (L2_L3_ST_syn S2)
  end.

Fixpoint L2_L3_S_scalar (ca : Gamma_A) (s : Playground1.S_scalar eval_AT sname cst ck cb co (ca := ca)) : S_scalar :=
  match s with
    | Playground1.S_var n => S_var n
    | Playground1.S_0 => S_0
    | Playground1.S_1 => S_1
    | Playground1.S_delta A a1 a2 => S_delta (L2_L3_A_base a1) (L2_L3_A_base a2)
    | Playground1.S_add s1 s2 => S_add (L2_L3_S_scalar s1) (L2_L3_S_scalar s2)
    | Playground1.S_mul s1 s2 => S_mul (L2_L3_S_scalar s1) (L2_L3_S_scalar s2)
    | Playground1.S_conj s => S_conj (L2_L3_S_scalar s)
    | Playground1.BK_inner A b k => BK_inner (L2_L3_B_bra b) (L2_L3_K_ket k)
    | Playground1.S_sum A st n s =>
        S_sum (L2_L3_ST_syn st) n (L2_L3_S_scalar s)
  end
with L2_L3_K_ket (ca : Gamma_A) A (k : Playground1.K_ket eval_AT sname cst ck cb co (ca := ca) A) : K_ket :=
  match k with
    | Playground1.K_var n => K_var n
    | Playground1.K_0 A => K_0 (AT_ground A)
    | Playground1.K_ground A a => K_ground (L2_L3_A_base a)
    | Playground1.B_adj A b => B_adj (L2_L3_B_bra b)
    | Playground1.K_scale s A k => K_scale (L2_L3_S_scalar s) (L2_L3_K_ket k)
    | Playground1.K_add A k1 k2 => K_add (L2_L3_K_ket k1) (L2_L3_K_ket k2)
    | Playground1.K_apply A1 A2 o k => K_apply (L2_L3_O_opt o) (L2_L3_K_ket k)
    | Playground1.K_ten A1 A2 k1 k2 => K_ten (L2_L3_K_ket k1) (L2_L3_K_ket k2)
    | Playground1.K_sum As A st n k =>
        K_sum (L2_L3_ST_syn st) n (L2_L3_K_ket k)
  end
with L2_L3_B_bra (ca : Gamma_A) A (b : Playground1.B_bra eval_AT sname cst ck cb co (ca := ca) A) : B_bra :=
  match b with
    | Playground1.B_var n => B_var n
    | Playground1.B_0 A => B_0 (AT_ground A)
    | Playground1.B_ground A a => B_ground (L2_L3_A_base a)
    | Playground1.K_adj A k => K_adj (L2_L3_K_ket k)
    | Playground1.B_scale s A b => B_scale (L2_L3_S_scalar s) (L2_L3_B_bra b)
    | Playground1.B_add A b1 b2 => B_add (L2_L3_B_bra b1) (L2_L3_B_bra b2)
    | Playground1.B_apply A1 A2 b o => B_apply (L2_L3_B_bra b) (L2_L3_O_opt o)
    | Playground1.B_ten A1 A2 b1 b2 => B_ten (L2_L3_B_bra b1) (L2_L3_B_bra b2)
    | Playground1.B_sum As A st n b =>
        B_sum (L2_L3_ST_syn st) n (L2_L3_B_bra b)
  end
with L2_L3_O_opt (ca : Gamma_A) A1 A2 (o : Playground1.O_opt eval_AT sname cst ck cb co (ca := ca) A1 A2) : O_opt :=
  match o with
    | Playground1.O_var n => O_var n
    | Playground1.O_0 A1 A2 => O_0 (AT_ground A1) (AT_ground A2)
    | Playground1.O_1 A => O_1 (AT_ground A)
    | Playground1.KB_outer A1 A2 k b => KB_outer (L2_L3_K_ket k) (L2_L3_B_bra b)
    | Playground1.O_adj A1 A2 o => O_adj (L2_L3_O_opt o)
    | Playground1.O_scale s A1 A2 o => O_scale (L2_L3_S_scalar s) (L2_L3_O_opt o)
    | Playground1.O_add A1 A2 o1 o2 => O_add (L2_L3_O_opt o1) (L2_L3_O_opt o2)
    | Playground1.O_comp A1 A2 A3 o1 o2 => O_comp (L2_L3_O_opt o1) (L2_L3_O_opt o2)
    | Playground1.O_ten A1 A2 A3 A4 o1 o2 => O_ten (L2_L3_O_opt o1) (L2_L3_O_opt o2)
    | Playground1.O_sum As A1 A2 st n o =>
        O_sum (L2_L3_ST_syn st) n (L2_L3_O_opt o)
  end.

Lemma L2_L3_A_type (ca : Gamma_A) (A : AType) (a : Playground1.A_base eval_AT (ca := ca) A) :
  atype_checker ca (L2_L3_A_base a) = Some A.
Proof.
elim: a=>//.
by move=> /= A1 A2 a1 -> a2 ->.
by move=> /= A1 A2 a ->.
...
Lemma L2_L3_ST_type (ca : Gamma_A) (A : AType) (s : Playground1.ST_syn cst A) :
  sttype_checker ca (L2_L3_ST_syn s) = Some A.
Proof.
elim: s=>//.
by move=> /= A1 A2 S1 -> S2 ->.
Qed.

Let L2_L3_S_type_eq ca (s : Playground1.S_scalar eval_AT sname cst ck cb co) :=
  stype_checker ca (L2_L3_S_scalar (ca := ca) s) = Some DScale.
Let L2_L3_K_type_eq ca A (k : Playground1.K_ket eval_AT sname cst ck cb co A) :=
  ktype_checker ca (L2_L3_K_ket (ca := ca) k) = Some (DKet A).
Let L2_L3_B_type_eq ca A (b : Playground1.B_bra eval_AT sname cst ck cb co A) :=
  btype_checker ca (L2_L3_B_bra (ca := ca) b) = Some (DBra A).
Let L2_L3_O_type_eq ca A1 A2 (o : Playground1.O_opt eval_AT sname cst ck cb co A1 A2) :=
  otype_checker ca (L2_L3_O_opt (ca := ca) o) = Some (DOpt (A1,A2)).

Lemma L2_L3_All_type ca : 
  (forall s, @L2_L3_S_type_eq ca s) /\ 
  (forall A k, @L2_L3_K_type_eq ca A k) /\
  (forall A b, @L2_L3_B_type_eq ca A b) /\
  (forall A1 A2 o, @L2_L3_O_type_eq ca A1 A2 o).
Proof.
move: ca; apply Playground1.All_syn_mutind=>//; 
rewrite /L2_L3_S_type_eq /L2_L3_B_type_eq /L2_L3_K_type_eq /L2_L3_O_type_eq.
(* about scalar *)
- by move=> /= ca A a1 a2; rewrite !L2_L3_A_type eqxx.
- by move=> /= ca s1 -> s2 ->.
- by move=> /= ca s1 -> s2 ->.
- by move=> /= ca A b -> k ->; rewrite eqxx.
- by move=> /= ca A st n s; rewrite L2_L3_ST_type.
(* about ket *)
- by move=> /= ca A a; rewrite L2_L3_A_type.
- by move=> /= ca A b ->.
- by move=> /= ca s -> A k ->.
- by move=> /= ca A k1 -> k2 ->; rewrite eqxx.
- by move=> /= ca A1 A2 o -> k ->; rewrite /= eqxx.
- by move=> /= ca A1 A2 k1 -> k2 ->.
- by move=> /= ca As A st n k; rewrite L2_L3_ST_type.
(* about bra *)
- by move=> /= ca A a; rewrite L2_L3_A_type.
- by move=> /= ca A k ->.
- by move=> /= ca s -> A b ->.
...
- by move=> /= ca As A st n b; rewrite L2_L3_ST_type.
(* about opt *)
...
- by move=> /= ca As A1 A2 st n o; rewrite L2_L3_ST_type.
Qed.

Lemma L2_L3_S_type ca (s : Playground1.S_scalar eval_AT sname cst ck cb co) :
  stype_checker ca (L2_L3_S_scalar (ca := ca) s) = Some DScale.
Proof. by move: (L2_L3_All_type ca) s=>[]. Qed.

Lemma L2_L3_K_type ca A (k : Playground1.K_ket eval_AT sname cst ck cb co A) :
  ktype_checker ca (L2_L3_K_ket (ca := ca) k) = Some (DKet A).
Proof. by move: (L2_L3_All_type ca) A k=>[] _ []. Qed.

Lemma L2_L3_B_type ca A (b : Playground1.B_bra eval_AT sname cst ck cb co A) :
  btype_checker ca (L2_L3_B_bra (ca := ca) b) = Some (DBra A).
Proof. by move: (L2_L3_All_type ca) A b=>[] _ [] _ []. Qed.

Lemma L2_L3_O_type ca A1 A2 (o : Playground1.O_opt eval_AT sname cst ck cb co A1 A2) :
  otype_checker ca (L2_L3_O_opt (ca := ca) o) = Some (DOpt (A1,A2)).
Proof. by move: (L2_L3_All_type ca) A1 A2 o=>[] _ [] _ []. Qed.

Lemma L2_L3_A_sem (ca : Gamma_A) (A : AType) 
  (a : Playground1.A_base eval_AT (ca := ca) A) (av : A_value ca) :
  A_sem av (L2_L3_A_base a) A = Playground1.A_sem av a.
Proof.
elim: a=>//; clear A.
by move=> /= n; rewrite A_set_id.
by move=> /= A a; rewrite A_set_id.
by move=> /= A1 A2 a1 + a2; rewrite !L2_L3_A_type A_set_id=>->->.
by move=> /= A1 A2 a; rewrite L2_L3_A_type A_set_id=>->.
by move=> /= A1 A2 a; rewrite L2_L3_A_type A_set_id=>->.
Qed.

Lemma L2_L3_ST_sem (ca : Gamma_A) (A : AType) (s : Playground1.ST_syn cst A) :
  ST_sem ca stv (L2_L3_ST_syn s) A = Playground1.ST_sem stv s.
Proof.
elim: s=>//; clear A.
by move=> /= n; rewrite ST_set_id.
by move=> /= A1 A2 S1 + S2; rewrite !L2_L3_ST_type ST_set_id=>->->.
Qed.

Let L2_L3_S_sem_eq ca (s : Playground1.S_scalar eval_AT sname cst ck cb co) :=
  forall av : A_value ca, S_sem av (L2_L3_S_scalar s) = Playground1.S_sem stv sv kv bv ov av s.
Let L2_L3_K_sem_eq ca A (k : Playground1.K_ket eval_AT sname cst ck cb co A) :=
  forall av : A_value ca, K_sem av (L2_L3_K_ket k) A = Playground1.K_sem stv sv kv bv ov av k.
Let L2_L3_B_sem_eq ca A (b : Playground1.B_bra eval_AT sname cst ck cb co A) :=
  forall av : A_value ca, B_sem av (L2_L3_B_bra b) A = Playground1.B_sem stv sv kv bv ov av b.
Let L2_L3_O_sem_eq ca A1 A2 (o : Playground1.O_opt eval_AT sname cst ck cb co A1 A2) :=
  forall av : A_value ca, O_sem av (L2_L3_O_opt o) (A1, A2) = Playground1.O_sem stv sv kv bv ov av o.

Lemma L2_L3_All_sem ca : 
  (forall s, @L2_L3_S_sem_eq ca s) /\ 
  (forall A k, @L2_L3_K_sem_eq ca A k) /\
  (forall A b, @L2_L3_B_sem_eq ca A b) /\
  (forall A1 A2 o, @L2_L3_O_sem_eq ca A1 A2 o).
Proof.
move: ca; apply Playground1.All_syn_mutind=>//; 
rewrite /L2_L3_S_sem_eq /L2_L3_K_sem_eq /L2_L3_B_sem_eq /L2_L3_O_sem_eq.
(* about scalar *)
- by move=> /= ca A a1 a2 av; rewrite !L2_L3_A_type eqxx !L2_L3_A_sem.
- by move=> /= ca s1 IH1 s2 IH2 av; rewrite !L2_L3_S_type IH1 IH2.
- by move=> /= ca s1 IH1 s2 IH2 av; rewrite !L2_L3_S_type IH1 IH2.
- by move=> /= ca s IH av; rewrite L2_L3_S_type IH.
- by move=> /= ca A b IHb k IHk av; rewrite L2_L3_B_type L2_L3_K_type eqxx IHb IHk.
- move=> /= ca A st n s IH av; rewrite L2_L3_ST_type L2_L3_ST_sem.
  by under eq_bigr do rewrite IH.
(* about ket *)
- by move=> /= ca n av; rewrite V_set_id.
- by move=> /= ca A a av; rewrite L2_L3_A_type V_set_id L2_L3_A_sem.
- by move=> /= ca A b IH av; rewrite L2_L3_B_type V_set_id IH.
- by move=> /= ca s IHs A k IHk av; rewrite L2_L3_S_type L2_L3_K_type V_set_id IHs IHk.
- by move=> /= ca A k1 IH1 k2 IH2 av; rewrite !L2_L3_K_type eqxx V_set_id IH1 IH2.
- by move=> /= ca A1 A2 o IHo k IHk av; 
  rewrite L2_L3_O_type L2_L3_K_type/= eqxx V_set_id IHo IHk.
- by move=> /= ca A1 A2 k1 IH1 k2 IH2 av; rewrite !L2_L3_K_type V_set_id IH1 IH2.
- move=> /= ca As A st n k IH av; rewrite L2_L3_ST_type L2_L3_K_type V_set_id L2_L3_ST_sem.
  by under eq_bigr do rewrite IH.
(* about bra *)
- by move=> /= ca n av; rewrite V_set_id.
- by move=> /= ca A a av; rewrite L2_L3_A_type V_set_id L2_L3_A_sem.
- by move=> /= ca A k IH av; rewrite L2_L3_K_type V_set_id IH.
- by move=> /= ca s IHs A b IHb av; rewrite L2_L3_S_type L2_L3_B_type V_set_id IHs IHb.
- by move=> /= ca A b1 IH1 b2 IH2 av; rewrite !L2_L3_B_type eqxx V_set_id IH1 IH2.
- by move=> /= ca A1 A2 o IHo b IHb av; 
  rewrite L2_L3_O_type L2_L3_B_type/= eqxx V_set_id IHo IHb.
- by move=> /= ca A1 A2 b1 IH1 b2 IH2 av; rewrite !L2_L3_B_type V_set_id IH1 IH2.
- move=> /= ca As A st n b IH av; rewrite L2_L3_ST_type L2_L3_B_type V_set_id L2_L3_ST_sem.
  by under eq_bigr do rewrite IH.
(* about opt *)
- by move=> /= ca n av; rewrite O_set_idp.
- by move=> /= ca A av; rewrite O_set_idp.
- by move=> /= ca A1 A2 k IHk b IHb av; rewrite L2_L3_K_type L2_L3_B_type O_set_idp IHk IHb.
- by move=> /= ca A1 A2 o IH av; rewrite L2_L3_O_type O_set_idp IH.
- by move=> /= ca s IHs A1 A2 o IHo av; rewrite L2_L3_S_type L2_L3_O_type O_set_idp IHs IHo.
- by move=> /= ca A1 A2 o1 IH1 o2 IH2 av; rewrite !L2_L3_O_type eqxx O_set_idp IH1 IH2.
- by move=> /= ca A1 A2 A3 o1 IH1 o2 IH2 av; rewrite !L2_L3_O_type/= eqxx O_set_idp IH1 IH2.
- by move=> /= ca A1 A2 A3 A4 o1 IH1 o2 IH2 av; rewrite !L2_L3_O_type O_set_idp IH1 IH2.
- move=> /= ca As A1 A2 st n o IH av; rewrite L2_L3_ST_type L2_L3_O_type O_set_idp L2_L3_ST_sem.
  by under eq_bigr do rewrite IH.
Qed.

Lemma L2_L3_S_sem ca (s : Playground1.S_scalar eval_AT sname cst ck cb co) (av : A_value ca) :
  S_sem av (L2_L3_S_scalar s) = Playground1.S_sem stv sv kv bv ov av s.
Proof. by move: (L2_L3_All_sem ca) s av=>[]. Qed.

Lemma L2_L3_K_sem ca A (k : Playground1.K_ket eval_AT sname cst ck cb co A) (av : A_value ca) :
  K_sem av (L2_L3_K_ket k) A = Playground1.K_sem stv sv kv bv ov av k.
Proof. by move: (L2_L3_All_sem ca) A k av=>[] _ []. Qed.

Lemma L2_L3_B_sem ca A (b : Playground1.B_bra eval_AT sname cst ck cb co A) (av : A_value ca) :
  B_sem av (L2_L3_B_bra b) A = Playground1.B_sem stv sv kv bv ov av b.
Proof. by move: (L2_L3_All_sem ca) A b av=>[] _ [] _ []. Qed.

Lemma L2_L3_O_sem ca A1 A2 (o : Playground1.O_opt eval_AT sname cst ck cb co A1 A2) (av : A_value ca) :
  O_sem av (L2_L3_O_opt o) (A1, A2) = Playground1.O_sem stv sv kv bv ov av o.
Proof. by move: (L2_L3_All_sem ca) A1 A2 o av=>[] _ [] _ []. Qed.
