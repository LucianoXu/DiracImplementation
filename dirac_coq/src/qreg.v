...
Ltac move_extra := repeat match goal with
  | [ H : is_true (@eq_op Datatypes_nat__canonical__eqtype_Equality _ _) |- _ ]
    => move : H; try clear H
  | [ H : is_true (negb (@eq_op Datatypes_nat__canonical__eqtype_Equality _ _)) |- _ ]
    => move : H; try clear H
  | [ H : is_true (leq _ _) |- _ ]
    => move : H; try clear H
